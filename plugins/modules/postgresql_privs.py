...
- misc.not_a_real_collection.postgres
'''
...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.database import pg_quote_identifier
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.postgres import postgres_common_argument_spec
