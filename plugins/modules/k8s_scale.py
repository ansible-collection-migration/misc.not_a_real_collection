...
- misc.not_a_real_collection.k8s_name_options
- misc.not_a_real_collection.k8s_auth_options
- misc.not_a_real_collection.k8s_resource_options
- misc.not_a_real_collection.k8s_scale_options
'''
...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.k8s.scale import KubernetesAnsibleScaleModule
