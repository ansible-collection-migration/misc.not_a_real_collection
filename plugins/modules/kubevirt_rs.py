...
- misc.not_a_real_collection.kubevirt_vm_options
- misc.not_a_real_collection.kubevirt_common_options
'''
...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.kubevirt import (
    virtdict,
    KubeVirtRawModule,
    VM_COMMON_ARG_SPEC,
)
