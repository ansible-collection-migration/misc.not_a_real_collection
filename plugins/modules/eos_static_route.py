...
- misc.not_a_real_collection.eos
'''
...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.common.utils import is_masklen, validate_ip_address
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.common.utils import remove_default_spec, validate_prefix
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.eos.eos import get_config, load_config
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.eos.eos import eos_argument_spec
