...
- misc.not_a_real_collection.netapp.eseries
'''
EXAMPLES = """
...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.netapp import NetAppESeriesModule, create_multipart_formdata, request
