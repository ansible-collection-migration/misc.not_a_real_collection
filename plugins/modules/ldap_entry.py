...
- misc.not_a_real_collection.ldap.documentation
'''
...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.ldap import LdapGeneric, gen_specs
