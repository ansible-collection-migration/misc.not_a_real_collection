...
- misc.not_a_real_collection.oracle
- misc.not_a_real_collection.oracle_creatable_resource
- misc.not_a_real_collection.oracle_wait_options
- misc.not_a_real_collection.oracle_tags
'''
...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.oracle import oci_utils
