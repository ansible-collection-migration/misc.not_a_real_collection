...
- misc.not_a_real_collection.VmwareRestModule.documentation
'''
...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.vmware_httpapi.VmwareRestModule import API, VmwareRestModule
