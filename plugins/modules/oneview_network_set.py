...
- misc.not_a_real_collection.oneview
- misc.not_a_real_collection.oneview.validateetag
'''
...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.oneview import OneViewModuleBase, OneViewModuleResourceNotFound
