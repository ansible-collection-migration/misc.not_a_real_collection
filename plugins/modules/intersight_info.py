...
- misc.not_a_real_collection.intersight
'''
...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.remote_management.intersight import IntersightModule, intersight_argument_spec
