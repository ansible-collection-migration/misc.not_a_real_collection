...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.nxos.utils.utils import flatten_dict, get_interface_type, normalize_interface, search_obj_in_list, vlan_range_to_list
