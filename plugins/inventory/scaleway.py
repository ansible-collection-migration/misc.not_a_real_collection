...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.scaleway import SCALEWAY_LOCATION, parse_pagination_link
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    NAME = 'misc.not_a_real_collection.scaleway'
