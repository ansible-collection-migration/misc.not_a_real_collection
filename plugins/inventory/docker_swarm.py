...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.docker.common import update_tls_hostname, get_connect_params
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ...
    NAME = 'misc.not_a_real_collection.docker_swarm'
