...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.nos import nos
...
class TestPluginCLIConfNOS(unittest.TestCase):
    ...
    @patch('ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.nos.nos.Connection')
