...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.nso import nso
...
class TestJsonRpc(unittest.TestCase):
    @patch('ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.nso.nso.open_url')
