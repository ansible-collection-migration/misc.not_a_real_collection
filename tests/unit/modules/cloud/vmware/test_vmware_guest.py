...
from ansible_collections.misc.not_a_real_collection.plugins.modules import vmware_guest
...
def test_vmware_guest_with_parameters(mocker, capfd, testcase):
    if testcase.get('test_ssl_context', None):
        class mocked_ssl:
            pass
        mocker.patch('ansible_collections.misc.not_a_real_collection.plugins.module_utils.vmware.ssl', new=mocked_ssl)
