...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.netapp import AwsCvsRestAPI
from ansible_collections.misc.not_a_real_collection.plugins.modules.aws_netapp_cvs_active_directory \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.aws_netapp_cvs_active_directory.AwsCvsNetappActiveDir.get_activedirectoryId')
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.aws_netapp_cvs_active_directory.AwsCvsNetappActiveDir.get_activedirectory')
