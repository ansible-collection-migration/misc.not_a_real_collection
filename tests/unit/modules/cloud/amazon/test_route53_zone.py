...
from ansible_collections.misc.not_a_real_collection.plugins.modules import route53_zone
...
@patch('ansible_collections.misc.not_a_real_collection.plugins.module_utils.aws.core.HAS_BOTO3', new=True)
