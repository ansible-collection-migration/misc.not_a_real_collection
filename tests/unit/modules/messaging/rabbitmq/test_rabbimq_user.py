...
from ansible_collections.misc.not_a_real_collection.plugins.modules import rabbitmq_user
...
class TestRabbitMQUserModule(ModuleTestCase):
    ...
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.rabbitmq_user.RabbitMqUser.get')
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.rabbitmq_user.RabbitMqUser.check_password')
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.rabbitmq_user.RabbitMqUser.has_tags_modifications')
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.rabbitmq_user.RabbitMqUser.has_permissions_modifications')
    ...
    @patch('ansible.module_utils.basic.AnsibleModule.get_bin_path')
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.rabbitmq_user.RabbitMqUser._exec')
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.rabbitmq_user.RabbitMqUser._get_permissions')
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.rabbitmq_user.RabbitMqUser.has_tags_modifications')
    ...
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.rabbitmq_user.RabbitMqUser._exec')
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.rabbitmq_user.RabbitMqUser._get_permissions')
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.rabbitmq_user.RabbitMqUser.set_permissions')
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.rabbitmq_user.RabbitMqUser.has_tags_modifications')
