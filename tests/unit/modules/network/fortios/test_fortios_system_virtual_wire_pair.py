...
try:
    from ansible_collections.misc.not_a_real_collection.plugins.modules import fortios_system_virtual_wire_pair
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.misc.not_a_real_collection.plugins.modules.fortios_system_virtual_wire_pair.Connection')
