...
try:
    from ansible_collections.misc.not_a_real_collection.plugins.modules import fortios_wireless_controller_hotspot20_anqp_roaming_consortium
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.misc.not_a_real_collection.plugins.modules.fortios_wireless_controller_hotspot20_anqp_roaming_consortium.Connection')
