...
from ansible_collections.misc.not_a_real_collection.plugins.modules import nxos_bgp_af
...
class TestNxosBgpAfModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.nxos_bgp_af.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.nxos_bgp_af.get_config')
