...
class TestNetscalerSSLCertkeyModule(TestModule):
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('ansible_collections.misc.not_a_real_collection.plugins.modules.netscaler_ssl_certkey.get_nitro_client', m):
            with patch('ansible_collections.misc.not_a_real_collection.plugins.modules.netscaler_ssl_certkey.nitro_exception', MockException):
                self.module = netscaler_ssl_certkey
                result = self.failed()
