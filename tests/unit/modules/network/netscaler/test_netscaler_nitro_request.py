...
from ansible_collections.misc.not_a_real_collection.plugins.modules import netscaler_nitro_request
...
class TestNetscalerNitroRequestModule(TestModule):
    ...
    def test_edit_response_data_no_body_success_status(self):
        with patch('ansible_collections.misc.not_a_real_collection.plugins.modules.netscaler_nitro_request.AnsibleModule'):
            instance = netscaler_nitro_request.NitroAPICaller()
            r = None
            info = {
                'status': 200,
