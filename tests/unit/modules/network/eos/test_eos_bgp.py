...
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.eos.providers.cli.config.bgp.process import Provider
from ansible_collections.misc.not_a_real_collection.plugins.modules import eos_bgp
