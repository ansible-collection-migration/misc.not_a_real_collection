...
from ansible_collections.misc.not_a_real_collection.plugins.modules import eos_command
...
class TestEosCommandModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.eos_command.run_commands')
