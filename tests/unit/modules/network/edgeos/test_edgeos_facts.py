...
from ansible_collections.misc.not_a_real_collection.plugins.modules import edgeos_facts
...
class TestEdgeosFactsModule(TestEdgeosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.edgeos_facts.run_commands')
