...
from ansible_collections.misc.not_a_real_collection.plugins.modules import edgeos_command
...
class TestEdgeosCommandModule(TestEdgeosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.edgeos_command.run_commands')
