...
try:
    from ansible_collections.misc.not_a_real_collection.plugins.modules import fmgr_query
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.misc.not_a_real_collection.plugins.modules.fmgr_query.Connection')
    return connection_class_mock
