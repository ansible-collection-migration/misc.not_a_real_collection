...
try:
    from ansible_collections.misc.not_a_real_collection.plugins.modules import fmgr_fwobj_ippool6
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.misc.not_a_real_collection.plugins.modules.fmgr_fwobj_ippool6.Connection')
    return connection_class_mock
