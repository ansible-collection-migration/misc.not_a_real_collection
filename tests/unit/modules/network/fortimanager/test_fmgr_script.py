...
try:
    from ansible_collections.misc.not_a_real_collection.plugins.modules import fmgr_script
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.misc.not_a_real_collection.plugins.modules.fmgr_script.Connection')
    return connection_class_mock
