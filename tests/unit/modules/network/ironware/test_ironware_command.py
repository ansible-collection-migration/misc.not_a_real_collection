...
from ansible_collections.misc.not_a_real_collection.plugins.modules import ironware_command
...
class TestIronwareCommandModule(TestIronwareModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.ironware_command.run_commands')
