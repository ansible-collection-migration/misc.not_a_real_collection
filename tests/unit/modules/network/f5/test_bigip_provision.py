...
try:
    ...
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_provision import ModuleParameters
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_provision import ModuleManager
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_provision import ArgumentSpec
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_provision import ApiParameters
