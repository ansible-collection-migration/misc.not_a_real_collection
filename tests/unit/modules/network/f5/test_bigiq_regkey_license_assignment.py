...
try:
    ...
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigiq_regkey_license_assignment import ModuleParameters
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigiq_regkey_license_assignment import ModuleManager
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigiq_regkey_license_assignment import ArgumentSpec
