...
try:
    ...
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_device_group_member import Parameters
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_device_group_member import ModuleManager
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_device_group_member import ArgumentSpec
