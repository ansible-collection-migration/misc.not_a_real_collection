...
try:
    ...
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_device_dns import Parameters
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_device_dns import ModuleManager
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_device_dns import ArgumentSpec
