...
try:
    ...
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_gtm_monitor_firepass import ApiParameters
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_gtm_monitor_firepass import ModuleParameters
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_gtm_monitor_firepass import ModuleManager
    from ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_gtm_monitor_firepass import ArgumentSpec
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.bigip_gtm_monitor_firepass.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
