...
from ansible_collections.misc.not_a_real_collection.plugins.modules import iosxr_command
...
class TestIosxrCommandModule(TestIosxrModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.iosxr_command.run_commands')
