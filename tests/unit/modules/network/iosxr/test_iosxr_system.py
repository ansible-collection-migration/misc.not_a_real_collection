...
from ansible_collections.misc.not_a_real_collection.plugins.modules import iosxr_system
...
class TestIosxrSystemModule(TestIosxrModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.iosxr_system.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.iosxr_system.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_is_cliconf = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.iosxr_system.is_cliconf')
