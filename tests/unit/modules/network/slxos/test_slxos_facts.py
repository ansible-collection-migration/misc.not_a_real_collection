...
from ansible_collections.misc.not_a_real_collection.plugins.modules import slxos_facts
...
class TestSlxosFactsModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.slxos_facts.run_commands')
