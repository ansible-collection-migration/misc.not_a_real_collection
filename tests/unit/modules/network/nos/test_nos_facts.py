...
from ansible_collections.misc.not_a_real_collection.plugins.modules import nos_facts
...
class TestNosFactsModule(TestNosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.nos_facts.run_commands')
