...
from ansible_collections.misc.not_a_real_collection.plugins.modules import ce_static_route_bfd
...
class TestCloudEngineLacpModule(TestCloudEngineModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.ce_static_route_bfd.get_nc_config')
        self.get_nc_config = self.mock_get_config.start()

        self.mock_set_config = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.ce_static_route_bfd.set_nc_config')
