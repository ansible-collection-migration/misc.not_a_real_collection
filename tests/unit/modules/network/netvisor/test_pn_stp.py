...
from ansible_collections.misc.not_a_real_collection.plugins.modules import pn_stp
...
class TestStpModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.pn_stp.run_cli')
