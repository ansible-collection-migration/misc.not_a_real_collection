...
from ansible_collections.misc.not_a_real_collection.plugins.modules import pn_port_cos_rate_setting
...
class TestPortCosRateSettingModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.pn_port_cos_rate_setting.run_cli')
