...
from ansible_collections.misc.not_a_real_collection.plugins.modules import pn_log_audit_exception
...
class TestLogAuditExceptionModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.pn_log_audit_exception.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.pn_log_audit_exception.check_cli')
