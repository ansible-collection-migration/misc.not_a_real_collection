...
from ansible_collections.misc.not_a_real_collection.plugins.modules import pn_snmp_community
...
class TestSnmpCommunityModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.pn_snmp_community.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.pn_snmp_community.check_cli')
