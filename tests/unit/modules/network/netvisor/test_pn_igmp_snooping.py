...
from ansible_collections.misc.not_a_real_collection.plugins.modules import pn_igmp_snooping
...
class TestAdminServiceModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.pn_igmp_snooping.run_cli')
