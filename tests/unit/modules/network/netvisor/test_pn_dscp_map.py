...
from ansible_collections.misc.not_a_real_collection.plugins.modules import pn_dscp_map
...
class TestDscpMapModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.pn_dscp_map.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.pn_dscp_map.check_cli')
