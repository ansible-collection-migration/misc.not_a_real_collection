...
from ansible_collections.misc.not_a_real_collection.plugins.modules import onyx_command
...
class TestOnyxCommandModule(TestOnyxModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch(
            'ansible_collections.misc.not_a_real_collection.plugins.modules.onyx_command.run_commands')
