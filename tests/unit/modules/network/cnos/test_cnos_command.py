...
from ansible_collections.misc.not_a_real_collection.plugins.modules import cnos_command
...
class TestCnosCommandModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.cnos_command.run_commands')
