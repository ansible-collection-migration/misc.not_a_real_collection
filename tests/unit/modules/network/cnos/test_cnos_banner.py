...
from ansible_collections.misc.not_a_real_collection.plugins.modules import cnos_banner
...
class TestCnosBannerModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.cnos_banner.load_config')
