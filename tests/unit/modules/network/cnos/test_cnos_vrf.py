...
from ansible_collections.misc.not_a_real_collection.plugins.modules import cnos_vrf
...
class TestCnosVrfModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.cnos_vrf.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.cnos_vrf.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self._patch_is_switchport = patch(
            'ansible_collections.misc.not_a_real_collection.plugins.modules.cnos_vrf.is_switchport'
        )
