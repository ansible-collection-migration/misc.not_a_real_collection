...
from ansible_collections.misc.not_a_real_collection.plugins.modules import cnos_logging
...
class TestCnosLoggingModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.cnos_logging.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.cnos_logging.load_config')
