...
from ansible_collections.misc.not_a_real_collection.plugins.modules import icx_command
...
class TestICXCommandModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.icx_command.run_commands')
