...
from ansible_collections.misc.not_a_real_collection.plugins.modules import enos_facts
...
class TestEnosFacts(TestEnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch(
            'ansible_collections.misc.not_a_real_collection.plugins.modules.enos_facts.run_commands')
