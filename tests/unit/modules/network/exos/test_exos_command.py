...
from ansible_collections.misc.not_a_real_collection.plugins.modules import exos_command
...
class TestExosCommandModule(TestExosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.exos_command.run_commands')
