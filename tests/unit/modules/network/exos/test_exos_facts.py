...
from ansible_collections.misc.not_a_real_collection.plugins.modules import exos_facts
...
class TestExosFactsModule(TestExosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.exos.facts.legacy.base.run_commands')
