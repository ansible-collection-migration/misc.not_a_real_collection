...
from ansible_collections.misc.not_a_real_collection.plugins.modules import vyos_config
from ansible_collections.misc.not_a_real_collection.plugins.cliconf.vyos import Cliconf
