...
from ansible_collections.misc.not_a_real_collection.plugins.modules import vyos_facts
...
class TestVyosFactsModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.vyos.facts.legacy.base.run_commands')
        ...
        self.mock_get_capabilities = patch('ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.vyos.facts.legacy.base.get_capabilities')
