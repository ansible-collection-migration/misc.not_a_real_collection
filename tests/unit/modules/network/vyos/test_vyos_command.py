...
from ansible_collections.misc.not_a_real_collection.plugins.modules import vyos_command
...
class TestVyosCommandModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.vyos_command.run_commands')
