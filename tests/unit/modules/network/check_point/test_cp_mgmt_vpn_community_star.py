...
from ansible_collections.misc.not_a_real_collection.plugins.modules import cp_mgmt_vpn_community_star
...
function_path = 'ansible_collections.misc.not_a_real_collection.plugins.modules.cp_mgmt_vpn_community_star.api_call'
