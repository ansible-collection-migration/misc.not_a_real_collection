...
from ansible_collections.misc.not_a_real_collection.plugins.modules import cp_mgmt_multicast_address_range
...
function_path = 'ansible_collections.misc.not_a_real_collection.plugins.modules.cp_mgmt_multicast_address_range.api_call'
