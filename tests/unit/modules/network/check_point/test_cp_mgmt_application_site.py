...
from ansible_collections.misc.not_a_real_collection.plugins.modules import cp_mgmt_application_site
...
function_path = 'ansible_collections.misc.not_a_real_collection.plugins.modules.cp_mgmt_application_site.api_call'
