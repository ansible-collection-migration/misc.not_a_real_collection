...
from ansible_collections.misc.not_a_real_collection.plugins.modules import cp_mgmt_service_icmp6
...
function_path = 'ansible_collections.misc.not_a_real_collection.plugins.modules.cp_mgmt_service_icmp6.api_call'
