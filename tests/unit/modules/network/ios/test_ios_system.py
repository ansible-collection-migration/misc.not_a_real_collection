...
from ansible_collections.misc.not_a_real_collection.plugins.modules import ios_system
...
class TestIosSystemModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.ios_system.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.ios_system.load_config')
