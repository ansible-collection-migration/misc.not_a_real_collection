...
from ansible_collections.misc.not_a_real_collection.plugins.modules import ios_facts
...
class TestIosFactsModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.ios.facts.legacy.base.run_commands')
        ...
        self.mock_get_capabilities = patch('ansible_collections.misc.not_a_real_collection.plugins.module_utils.network.ios.facts.legacy.base.get_capabilities')
