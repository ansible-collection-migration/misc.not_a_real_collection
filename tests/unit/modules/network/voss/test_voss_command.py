...
from ansible_collections.misc.not_a_real_collection.plugins.modules import voss_command
...
class TestVossCommandModule(TestVossModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.voss_command.run_commands')
