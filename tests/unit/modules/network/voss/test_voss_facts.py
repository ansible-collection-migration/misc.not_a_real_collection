...
from ansible_collections.misc.not_a_real_collection.plugins.modules import voss_facts
...
class TestVossFactsModule(TestVossModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.misc.not_a_real_collection.plugins.modules.voss_facts.run_commands')
