...
from ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_quotas \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_quotas.NetAppONTAPQuotas.quota_entry_set')
    ...
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_quotas.NetAppONTAPQuotas.quota_entry_delete')
