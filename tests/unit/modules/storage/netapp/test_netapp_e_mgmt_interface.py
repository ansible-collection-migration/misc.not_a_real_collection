...
from ansible_collections.misc.not_a_real_collection.plugins.modules.netapp_e_mgmt_interface import MgmtInterface
...
class MgmtInterfaceTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.misc.not_a_real_collection.plugins.modules.netapp_e_mgmt_interface.request'
