...
from ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_nfs \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_nfs.NetAppONTAPNFS.delete_nfs')
    ...
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_nfs.NetAppONTAPNFS.get_nfs_service')
