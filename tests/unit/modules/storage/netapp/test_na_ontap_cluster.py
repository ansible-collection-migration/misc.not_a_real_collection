...
from ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_cluster \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_cluster.NetAppONTAPCluster.create_cluster')
