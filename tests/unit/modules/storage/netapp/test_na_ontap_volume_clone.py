...
from ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_volume_clone \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_volume_clone.NetAppONTAPVolumeClone.create_volume_clone')
