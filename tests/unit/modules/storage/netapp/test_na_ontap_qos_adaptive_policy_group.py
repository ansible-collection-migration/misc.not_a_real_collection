...
from ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_qos_adaptive_policy_group \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_qos_adaptive_policy_group.NetAppOntapAdaptiveQosPolicyGroup.get_policy_group')
