...
from ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_ndmp \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_ndmp.NetAppONTAPNdmp.ndmp_get_iter')
