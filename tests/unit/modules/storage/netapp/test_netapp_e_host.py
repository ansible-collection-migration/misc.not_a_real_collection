...
from ansible_collections.misc.not_a_real_collection.plugins.modules.netapp_e_host import Host
...
class HostTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.misc.not_a_real_collection.plugins.modules.netapp_e_host.request'
