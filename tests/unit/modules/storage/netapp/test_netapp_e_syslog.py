...
from ansible_collections.misc.not_a_real_collection.plugins.modules.netapp_e_syslog import Syslog
...
class AsupTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.misc.not_a_real_collection.plugins.modules.netapp_e_syslog.request'
