...
from ansible_collections.misc.not_a_real_collection.plugins.modules.na_ontap_dns \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.misc.not_a_real_collection.plugins.module_utils.netapp.OntapRestAPI.send_request')
