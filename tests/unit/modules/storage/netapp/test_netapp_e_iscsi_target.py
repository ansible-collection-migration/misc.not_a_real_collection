...
from ansible_collections.misc.not_a_real_collection.plugins.modules.netapp_e_iscsi_target import IscsiTarget
...
class IscsiTargetTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.misc.not_a_real_collection.plugins.modules.netapp_e_iscsi_target.request'
