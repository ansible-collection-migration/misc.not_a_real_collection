...
from ansible_collections.misc.not_a_real_collection.plugins.modules import lxca_nodes
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.remote_management.lxca.common import setup_conn
from ansible_collections.misc.not_a_real_collection.plugins.module_utils.remote_management.lxca.common import close_conn
...
class TestMyModule():
    ...
    @mock.patch('ansible_collections.misc.not_a_real_collection.plugins.modules.lxca_nodes.execute_module', autospec=True)
    ...
    @mock.patch('ansible_collections.misc.not_a_real_collection.plugins.module_utils.remote_management.lxca.common.setup_conn', autospec=True)
    @mock.patch('ansible_collections.misc.not_a_real_collection.plugins.modules.lxca_nodes.execute_module', autospec=True)
    @mock.patch('ansible_collections.misc.not_a_real_collection.plugins.modules.lxca_nodes.AnsibleModule', autospec=True)
    ...
    @mock.patch('ansible_collections.misc.not_a_real_collection.plugins.module_utils.remote_management.lxca.common.setup_conn', autospec=True)
    @mock.patch('ansible_collections.misc.not_a_real_collection.plugins.modules.lxca_nodes._nodes_by_uuid',
                autospec=True)
    @mock.patch('ansible_collections.misc.not_a_real_collection.plugins.modules.lxca_nodes.AnsibleModule',
                autospec=True)
