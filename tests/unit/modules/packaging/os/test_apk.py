...
from ansible_collections.misc.not_a_real_collection.plugins.modules import apk
...
class TestApkQueryLatest(unittest.TestCase):
    ...
    @mock.patch('ansible_collections.misc.not_a_real_collection.plugins.modules.apk.AnsibleModule')
